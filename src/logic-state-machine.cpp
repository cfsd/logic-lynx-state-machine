    ...
    switch(m_currentState){
        case asState::AS_OFF:
            ...
            if (m_firstCycleAsOff){
                ...
                std::cout << "Ping 127.0.0.1: " << system("ping 127.0.0.1 -c 1") << std::endl; // Docker compose down.
                std::cout << "Ping 10.42.2.11: " << system("ping 10.42.2.11 -c 1") << std::endl; // Docker compose down.
                std::cout << "Ping 0.0.0.0: " << system("ping 0.0.0.0 -c 1") << std::endl; // Docker compose down.
